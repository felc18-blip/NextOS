...
EOF
  ...
  # Disable bluez monitor entirely on devices without a Bluetooth chip
  # (S905W TV boxes). Without this wireplumber logs
  # "BlueZ system service is not available" on every boot.
  cat >${INSTALL}/usr/share/wireplumber/wireplumber.conf.d/90-disable-bluez-monitor.conf <<EOF
wireplumber.profiles = {
  main = {
