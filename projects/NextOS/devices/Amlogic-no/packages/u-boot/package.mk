...
# u-boot-script gera aml_autoscript + Generic_cfgload + Generic_cfgload_env
# em /usr/share/bootloader. Sem essa dep, install_pkg do u-boot-script fica
# órfão e os files não vão pra image/system. Resultado: Generic.img.gz sai
# sem aml_autoscript = TV box X4/X5/X5M cai em Android recovery (não sabe
# bootar do SD). Amlogic-nxtos resolve isso via UBOOT_FIRMWARE — aqui é
# explícito porque Amlogic-no não usa UBOOT_FIRMWARE.
PKG_DEPENDS_TARGET+=" u-boot-script"
