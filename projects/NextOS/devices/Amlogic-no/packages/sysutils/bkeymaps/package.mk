...
# Amlogic-no override: adiciona makeinstall_init (faltando no Arch-R global)
# pra que os keymaps sejam copiados também pro initramfs quando o pacote é
# puxado via PKG_DEPENDS_INIT.
...
PKG_DEPENDS_INIT="toolchain busybox:init"
