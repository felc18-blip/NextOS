...
make_target() {
  ...
  case ${TARGET_ARCH} in
    arm|aarch64)
      ...
      # Amlogic-no S905X5/X5M/S928X: cortex-a55/a76 com CRC32. GCC 16 exige
      # -march=armv8-a+crc explícito pra habilitar __crc32* intrinsics
      # consumidos pelo GLideN64 quando CRC_ARMV8=On. Sem isso, build falha
      # com "target specific option mismatch".
