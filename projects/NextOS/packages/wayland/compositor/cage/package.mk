...
# 2026-05-28 import CoreELEC a918a42d — cage 0.3.0 (Wayland kiosk compositor).
# Pacote NOVO no Arch-R/NextOS (não usado ainda; trazido pra base ficar pronta
# caso decidamos rota Panthor/mesa-puro). Localizado em wayland/compositor/
# (CoreELEC mantinha em addons/addon-depends/externalhelper-depends/cage).
PKG_NAME="cage"
PKG_VERSION="0.3.0"
