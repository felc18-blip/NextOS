...
# 2026-05-28 bump CoreELEC 37a596bf — wayland-protocols git-hash -> 1.48
# release oficial + patch novo "Cflags to pkg-config when headers installed"
# (fix build wlroots 0.20+ que inclui <wayland-protocols/xdg-shell-enum.h>).
# Sincronizado com coreelec-22 (incl. condicional DISPLAYSERVER/sysroot e
# fix do path pkgconfig de share -> lib).
