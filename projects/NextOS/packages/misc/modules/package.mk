...
case ${DEVICE} in
  RK3588|RK3399|SM8250|SM8550|SDM845|SM8650|Amlogic-nxtos)
    # gamepadtester e qterminal são úteis pra debug (testar USB controller
    # connection + abrir terminal Qt sem SSH). Vale incluir no nxtos.
...
case ${DEVICE} in
  RK3326|RK3399|RK3566|RK3588|S922X|SDM845|SM8250|SM8550|SM8650|Amlogic-nxtos)
    # commander = filemanager 2-pane estilo Midnight Commander, melhor pra
    # navegação em TV box que `fileman` (lista única).
