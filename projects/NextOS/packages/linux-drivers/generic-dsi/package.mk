...
makeinstall_target() {
  ...
  # dtbo.py is a better script handling not just panel, but also joypad, headphones, etc.
  cp -v "${PKG_BUILD}/"overlay_server*"/rocknix_dtbo.py" "${INSTALL}/usr/libexec/generic-dsi/nextos_dtbo.py"
