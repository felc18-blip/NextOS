...
post_makeinstall_target() {
  ...
  case ${DEVICE} in
    ...
    ;;
    Amlogic-nxtos)
      # TV box S905W 1080p — fonte 40 (TV viewing distance, > handheld).
      # Mali-450 não tem GPU temp sensor separado (compartilha CPU thermal
      # zone). Comment out gpu_temp idem S922X. MangoHud roda só GL hooks
      # (sem Vulkan no Utgard) — features limitadas mas FPS/CPU funcionam.
