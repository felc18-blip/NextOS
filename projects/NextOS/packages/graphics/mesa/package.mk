...
# 2026-05-28 import CoreELEC 0f9b7e3c — mesa 26.1.1 (não usado no Arch-R
# Amlogic-no atualmente: libMali blob Valhall direto. Importado pra ter base
# pronta caso decidamos rota Panthor/Lima/llvmpipe ou mesa via Westonpack).
