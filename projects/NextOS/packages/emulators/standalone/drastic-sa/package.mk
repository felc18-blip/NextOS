...
PKG_ARCH="aarch64"
# URL trocada pra RetroGFX/UnofficialOSAddOns (mesmo binário, host mais estável
# usado no fork NextOS-Elite-Edition do felipe). felc18-blip/packages tava 404.
PKG_URL="https://github.com/RetroGFX/UnofficialOSAddOns/raw/main/drastic.tar.gz"
PKG_DEPENDS_TARGET="toolchain nextos-hotkey"
