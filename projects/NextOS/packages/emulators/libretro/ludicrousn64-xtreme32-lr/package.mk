...
makeinstall_target() {
  ...
  cp ${PKG_BUILD}/*.so ${INSTALL}/usr/lib/libretro/ludicrousn64_xtreme32_libretro.so
  cp ${PKG_BUILD}/*.info ${INSTALL}/usr/lib/libretro/ludicrousn64_xtreme32_libretro.info
}
