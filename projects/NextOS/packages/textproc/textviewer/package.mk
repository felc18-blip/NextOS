...
PKG_LICENSE="MIT"
PKG_SITE="https://github.com/felc18-blip/nextos-textviewer"
...
pre_make_target() {
  # GCC 16 strict: main.cpp uses std::uint8_t without <cstdint>
  sed -i '1i#include <cstdint>' ${PKG_BUILD}/main.cpp
}
